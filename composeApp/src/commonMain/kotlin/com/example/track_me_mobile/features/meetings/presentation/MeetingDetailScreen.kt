        ...
        Column(modifier = Modifier.fillMaxSize().padding(paddingValues).padding(horizontal = 24.dp).verticalScroll(rememberScrollState())) {
            ...
            Row(verticalAlignment = Alignment.CenterVertically, modifier = Modifier.padding(bottom = 16.dp)) {
                ...
                Surface(color = TrackMePurple, shape = RoundedCornerShape(50)) {
                    Text(date, color = Color.White, modifier = Modifier.padding(horizontal = 16.dp, vertical = 4.dp))
                }
                if (meetingResult.isNotEmpty()) {
                    ...
                    Surface(
                        ...
                        Text(meetingResult, color = Color.White, modifier = Modifier.padding(horizontal = 12.dp, vertical = 4.dp), fontSize = 12.sp, fontWeight = FontWeight.Bold)
                    }
                }
            }
            ...
            ) { Box(contentAlignment = Alignment.Center) { Text(status, color = if (status == "Есть проблемы") Color.Black else Color.White, fontWeight = FontWeight.Bold) } }
            ...
            Row(verticalAlignment = Alignment.CenterVertically, modifier = Modifier.padding(top = 8.dp, bottom = 32.dp)) {
                Surface(
                    modifier = Modifier.weight(1f).height(56.dp).border(1.dp, TrackMePurple, RoundedCornerShape(12.dp)),
